...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-agentTransactions">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.transaction.fields.agent') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-agentTransactions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
