...
@endcan
        ...
        @endcan
        @can('balance_history_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.balance-histories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/balance-histories") || request()->is("admin/balance-histories/*") ? "c-active" : "" }}">
